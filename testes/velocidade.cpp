...
// Controle de velocidade
float velocidade_Referencia = 0.3;
...
void frente(float potEsquerda, float potDireita)
{
...
void controleAdaptativoVelocidade()
{
    ...
    pot_esquerda = tensaomotor_esquerda / 100000 * (tensao_bateria);
    pot_esquerda_teste = pot_esquerda;

    pot_direita = tensaomotor_direita / 100000 * (tensao_bateria);
